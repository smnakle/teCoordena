                            ...
                            <div class="row">
                                <form class="form-horizontal" role="form" action="UpdateDadosFase.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" name="inicio" placeholder="" id="diniFase" required="required" value="<?php echo $inicio; ?>">
                                        </div>
                                        <label for="inputFim" class="col-sm-1 control-label">Fim</label>
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" name="fim" value ="<?php echo $fim; ?>" id="dfimFase" required="required" >
                                        </div>
                                    </div>
